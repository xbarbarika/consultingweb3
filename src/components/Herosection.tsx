...
export default function HeroSection() {
  return (
    <section id="hero" className="relative text-white min-h-[90vh] sm:min-h-[90vh] lg:min-h-screen w-full pt-36 pb-24 px-4 sm:px-6 overflow-hidden hero-section" style={{backgroundImage: 'url(/hero.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'}}>
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center lg:mt-0 md:-mt-12 -mt-16">
        <div className="text-center">
          <h1 className="w-full max-w-[340px] sm:max-w-[500px] md:max-w-[700px] lg:max-w-[1200px] mx-auto text-center font-medium text-transparent bg-clip-text mb-4 sm:mb-12 lg:mb-20 mt-0 sm:mt-8 lg:mt-12 text-[26px] xs:text-[30px] sm:text-[32px] md:text-[40px] lg:text-[52px] leading-[30px] xs:leading-[34px] sm:leading-[36px] md:leading-[44px] lg:leading-[60px] animate-fade-in-up hero-title text-overflow-fix" style={{
          ...
          <p className="text-gray-300 mt-5 sm:mt-4 lg:mt-6 text-sm sm:text-base max-w-xs sm:max-w-md lg:max-w-2xl mx-auto px-2 sm:px-0 animate-fade-in-up-delayed hero-subtitle text-overflow-fix landscape-spacing">
          ...
          <div className="mt-5 sm:mt-6 lg:mt-8 flex flex-row justify-center gap-3 sm:gap-4 px-2 sm:px-0 animate-fade-in-up-more-delayed hero-buttons">
            <button className="px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-white/10 border border-white/20 text-white font-medium hover:bg-white/20 hover:scale-105 transition-all duration-300 text-sm sm:text-base animate-pulse-subtle hero-button landscape-button">Learn more</button>
            <button className="px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-white text-black font-medium hover:bg-gray-200 hover:scale-105 transition-all duration-300 text-sm sm:text-base animate-pulse-subtle hero-button landscape-button">Book Demo</button>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-[50px] sm:bottom-[70px] md:bottom-[50px] left-0 right-0 z-10 grid grid-cols-2 gap-2 sm:gap-3 max-w-[320px] sm:max-w-[520px] mx-auto px-3 sm:px-4 lg:hidden footer-badges">
