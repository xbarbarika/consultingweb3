  ...
  return (
    <div className="text-white">
      <div className="min-h-screen" style={{ backgroundImage: 'url(/bg-pages/D3-4.svg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
        ...
        {/* Service Label */}
        <div className="text-white/60 text-lg sm:text-xl font-medium leading-7 mt-16 mb-6 ml-4 sm:ml-8 md:ml-12 lg:ml-16 xl:ml-[66px]" style={{ fontFamily: 'Inter' }}>Service <span className="text-white/90 font-medium">SEO</span></div>
        {/* Main Heading */}
        ...
        <div className="mt-8 ml-4 sm:ml-8 md:ml-12 lg:ml-16 xl:ml-[66px]">
          <Link href="/book-demo">
            <div 
              ...
              style={{
                background: 'linear-gradient(90deg, #5d8bff 0%, #5bafff 50%, #3f7ffd 100%)',
              }}
            >
