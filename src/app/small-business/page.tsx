      ...
      <div className="min-h-screen w-full" style={{
        ...
        <main className="w-full flex flex-col items-center justify-start pt-48 px-4 md:px-8 lg:px-16 min-h-screen">
          ...
          <p style={{ 
            ...
            Connect with your local community and compete with larger businesses.<br />
            With Barbarika, you get affordable marketing that drives foot traffic and online sales.
          </p>
          {/* Book Demo Button */}
