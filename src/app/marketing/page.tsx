...
export default function Marketing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-gray-200 relative overflow-x-hidden">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10 md:pt-20 md:pb-20">
        {/* Hero Section */}
        <header className="text-center mb-12 md:mb-20 relative">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold mb-4 md:mb-6 leading-tight" style={{ 
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto mb-8 md:mb-10 px-4">
        ...
        {/* Services Grid */}
        <div className="w-full p-0 m-0 md:-ml-4">
          {/* First row - Card and Image */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-12 sm:mb-16 items-stretch">
            {/* Main Card - Takes 2/3 on desktop */}
            {filteredSections.length > 0 && (
            <div 
              key={filteredSections[0].key}
              className="relative overflow-hidden rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 flex flex-col transition-all duration-500 group md:col-span-2 h-auto min-h-[250px] sm:min-h-[300px] md:min-h-[350px] lg:min-h-[400px] aspect-[4/3] md:aspect-auto"
              style={{
            ...
            >
                <div 
                  className="absolute inset-0 transition-all duration-500 opacity-0 group-hover:opacity-40"
                  style={{
                ...
                <div className="relative z-10 flex-1 flex flex-col group">
                  ...
                  <a 
                    href="#contact" 
                    className="group relative mt-auto self-stretch sm:self-start px-4 py-3 sm:px-6 sm:py-3 md:px-8 md:py-4 rounded-2xl font-bold text-white overflow-hidden transition-all duration-500 hover:shadow-2xl text-sm sm:text-base md:text-lg bg-black/50 border-2 border-red-500 hover:bg-black/70 w-full sm:w-auto text-center sm:text-left"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-12 sm:mb-16">
            {filteredSections.slice(1, 3).map((section, index) => (
              <div 
                key={section.key}
                className="relative overflow-hidden rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 flex flex-col transition-all duration-500 group h-auto min-h-[250px] sm:min-h-[300px] aspect-[4/3]"
                style={{
                  background: 'rgba(0, 0, 0, 0.7)',
                  backdropFilter: 'blur(12px)',
                  border: '1px solid rgba(255, 255, 255, 0.08)',
              ...
              >
                <div 
                  className="absolute inset-0 transition-all duration-500 opacity-0 group-hover:opacity-40"
                  style={{
                    backgroundImage: `url(/bg-${index + 2}.jpg)`,
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat',
                    filter: 'saturate(1.2) contrast(1.1)'
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-12 mb-16">
            {filteredSections[3] && (
              <div 
                ...
                className="relative overflow-hidden rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 flex flex-col transition-all duration-500 group md:col-start-2 md:col-span-2 h-auto min-h-[250px] sm:min-h-[300px] aspect-[4/3] md:aspect-auto"
                style={{
                  background: 'rgba(0, 0, 0, 0.7)',
                  backdropFilter: 'blur(12px)',
                  border: '1px solid rgba(255, 255, 255, 0.08)',
