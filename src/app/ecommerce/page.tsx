      ...
      <div className="min-h-screen w-full" style={{
        ...
        <main className="w-full flex flex-col items-center justify-start pt-48 px-4 md:px-8 lg:px-16 min-h-screen">
          ...
          <p style={{ 
            ...
            Turn browsers into buyers and one-time customers into loyal advocates.<br />
            With Barbarika, you get eCommerce marketing that maximizes ROAS and lifetime value.
          </p>
          {/* Book Demo Button */}
