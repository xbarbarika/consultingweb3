      ...
      <div className="min-h-screen w-full" style={{
        ...
        <main className="w-full flex flex-col items-center justify-start pt-24 md:pt-32 lg:pt-48 px-4 md:px-8 lg:px-16 min-h-screen">
          ...
          <h1 className="text-center text-white font-medium leading-tight mb-6 px-4" style={{ 
            ...
            Drive Sales. Boost Conversions. Scale Revenue.
          </h1>
          {/* Subheading */}
          <p className="text-center text-white opacity-50 mb-12 md:mb-15 px-4" style={{ 
            ...
            Transform browsers into buyers with conversion-focused strategies that maximize every touchpoint.<br />
            With Barbarika, you get eCommerce marketing that drives sales, reduces cart abandonment, and builds loyalty.
          </p>
          {/* Book Demo Button */}
            ...
            <div className="relative mx-auto" style={{ 
              ...
              <div className="pl-6">
                <p style={{ 
                  ...
                  • Conversion rate optimization and sales funnel enhancement
                </p>
                ...
                <p style={{ 
                  ...
                  • Product page optimization and shopping cart abandonment
                </p>
                ...
                <p style={{ 
                  ...
                  • Performance advertising across Google, Facebook, and Amazon
                </p>
              </div>
            </div>
          </div>
