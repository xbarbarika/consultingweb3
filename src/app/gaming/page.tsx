      ...
      <div className="min-h-screen w-full" style={{
        ...
        <main className="w-full flex flex-col items-center justify-start pt-24 md:pt-32 lg:pt-48 px-4 md:px-8 lg:px-16 min-h-screen">
          ...
          <h1 className="text-center text-white font-medium leading-tight mb-6 px-4" style={{ 
            ...
            Engage Players. Build Communities. Drive Downloads.
          </h1>
          {/* Subheading */}
          <p className="text-center text-white opacity-50 mb-12 md:mb-15 px-4" style={{ 
            ...
            Level up your game marketing with strategies that capture players&apos; attention and build lasting engagement.<br />
            With Barbarika, you get gaming marketing that drives downloads, retention, and community growth.
          </p>
          {/* Book Demo Button */}
            ...
            <div className="relative mx-auto" style={{ 
              ...
              <div className="pl-6">
                <p style={{ 
                  ...
                  • Mobile game user acquisition and App Store optimization
                </p>
                ...
                <p style={{ 
                  ...
                  • Gaming influencer partnerships and sponsorships
                </p>
                ...
                <p style={{ 
                  ...
                  • Community building on Discord, Twitch, and YouTube
                </p>
                ...
                <p style={{ 
                  ...
                  • In-game monetization and player retention strategies
                </p>
              </div>
            </div>
          </div>
