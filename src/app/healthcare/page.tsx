      ...
      <div className="min-h-screen w-full" style={{
        ...
        <main className="w-full flex flex-col items-center justify-start pt-24 md:pt-32 lg:pt-48 px-4 md:px-8 lg:px-16 min-h-screen">
          ...
          <h1 className="text-center text-white font-medium leading-tight mb-6 px-4" style={{ 
            ...
            Heal Patients. Build Trust. Improve Outcomes.
          </h1>
          {/* Subheading */}
          <p className="text-center text-white opacity-50 mb-12 md:mb-15 px-4" style={{ 
            ...
            Connect with patients while maintaining the highest standards of compliance and care.<br />
            With Barbarika, you get healthcare marketing that builds trust and drives patient engagement.
          </p>
          {/* Book Demo Button */}
            ...
            <div className="relative mx-auto" style={{ 
              ...
              <div className="pl-6">
                <p style={{ 
                  ...
                  • HIPAA-compliant marketing strategies for patient acquisition
                </p>
                ...
                <p style={{ 
                  ...
                  • Medical SEO and reputation management for practices
                </p>
                ...
                <p style={{ 
                  ...
                  • Healthcare content marketing and thought leadership
                </p>
                ...
                <p style={{ 
                  ...
                  • Telemedicine platform promotion and patient acquisition
                </p>
              </div>
            </div>
          </div>
