      ...
      <div className="min-h-screen w-full" style={{
        ...
        <main className="w-full flex flex-col items-center justify-start pt-48 px-4 md:px-8 lg:px-16 min-h-screen">
          ...
          <p style={{ 
            ...
            Navigate the complex crypto landscape with expert marketing strategies.<br />
            With Barbarika, you get specialized blockchain marketing that drives adoption and growth.
          </p>
          {/* Book Demo Button */}
