      ...
      <div className="min-h-screen w-full" style={{
        ...
        <main className="w-full flex flex-col items-center justify-start pt-48 px-4 md:px-8 lg:px-16 min-h-screen">
          ...
          <p style={{ 
            ...
            Transform complex technical features into compelling value propositions.<br />
            With Barbarika, you get software marketing that drives enterprise adoption and growth.
          </p>
          {/* Book Demo Button */}
