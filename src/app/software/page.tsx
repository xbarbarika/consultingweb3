      ...
      <div className="min-h-screen w-full" style={{
        ...
        <main className="w-full flex flex-col items-center justify-start pt-24 md:pt-32 lg:pt-48 px-4 md:px-8 lg:px-16 min-h-screen">
          ...
          <h1 className="text-center text-white font-medium leading-tight mb-6 px-4" style={{ 
            ...
            Scale Solutions. Drive Adoption. Accelerate Growth.
          </h1>
          {/* Subheading */}
          <p className="text-center text-white opacity-50 mb-12 md:mb-15 px-4" style={{ 
            ...
            Transform technical complexity into compelling value propositions that resonate with decision-makers.<br />
            With Barbarika, you get software marketing that drives enterprise adoption and accelerates growth.
          </p>
          {/* Book Demo Button */}
            ...
            <div className="relative mx-auto" style={{ 
              ...
              <div className="pl-6">
                <p style={{ 
                  ...
                  • Enterprise software marketing and B2B lead generation
                </p>
                ...
                <p style={{ 
                  ...
                  • Product positioning and competitive analysis strategies
                </p>
                ...
                <p style={{ 
                  ...
                  • Developer relations and technical content marketing
                </p>
                ...
                <p style={{ 
                  ...
                  • API documentation and integration partner programs
                </p>
              </div>
            </div>
          </div>
